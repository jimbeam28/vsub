...
def process_video(input_path: Path, config: Config) -> Path:
    ...
    print(f"视频信息: {video_info.resolution} @ {video_info.fps:.2f}fps, 时长: {video_info.duration:.2f}s")
